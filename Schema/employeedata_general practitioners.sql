...
--
-- Table structure for table `general practitioners`
--

DROP TABLE IF EXISTS `general practitioners`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `general practitioners` (
  `idEmployees` int NOT NULL,
  `Name` varchar(45) DEFAULT NULL,
  `Available` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `Appointment Date` date DEFAULT NULL,
  PRIMARY KEY (`idEmployees`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `general practitioners`
--
